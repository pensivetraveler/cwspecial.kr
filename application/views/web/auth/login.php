	...
	<div class="h-px-800 d-flex flex-column justify-content-center">
		...
		<div class="w-px-600 mt-1 mx-auto">
			...
			<div class="d-flex justify-content-between align-items-center">
				<button class="btn btn-outline-primary d-grid w-px-150" type="button" onclick="redirect('/auth/find')">ID/PW 찾기</button>
				<button class="btn btn-primary d-grid w-px-150" type="submit">로그인</button>
				<button class="btn btn-outline-primary d-grid w-px-150" type="button" onclick="redirect('/auth/terms')">회원가입</button>
			</div>
			<?php
				echo form_close();
			?>
