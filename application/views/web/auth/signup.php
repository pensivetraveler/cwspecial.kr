...
<div class="row mt-12">
	...
	<div class="col-md-12">
		...
		<div class="card mb-6">
			...
			<div class="card-body">
				<?php $this->load->view("admin/layout/form_{$formType}_custom_unique", ['item' => $code]); ?>
		...
		<div class="card mb-6">
			...
			<div class="card-body">
				<?php $this->load->view("admin/layout/form_{$formType}_custom_unique", ['item' => $id]); ?>
				<?php $this->load->view("admin/layout/form_{$formType}_custom_unique", ['item' => $email]); ?>
				<?php $this->load->view("admin/layout/form_{$formType}_group_".$user_password['view'], ['item' => $user_password]); ?>
			</div>
		</div>
		<div class="row">
