...
$(function () {
    ...
    if (dt_table.length) {
        var dt_user = dt_table.DataTable({
            ...
            serverSide: true,
            ajax: {
                url: common.API_URI, // JSON file to add data,
                type: 'GET',
                data: function(data) {
                    const req = {
                        ...common.API_PARAMS,
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 4,
                    render: function (data, type, full, meta) {
                        var $created_id = full['created_id']['id'];
                        return '<span >' + $created_id + '</span>';
                    }
                },
                {
                    targets: 5,
                    render: function (data, type, full, meta) {
                        var $created_dt = full['created_dt'];
                        return '<span >' + $created_dt + '</span>';
                    }
                },
                {
                    targets: 6,
